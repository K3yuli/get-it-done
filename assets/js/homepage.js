...
// var for the repo container section
...
var displayRepos = function(repos, searchTerm) {
    ...
    for (var i = 0; i < repos.length; i++) {
        ...
        if(repos[i].open_issues_count > 0) {
            ...
            statusEl.innerHTML = "<i class = 'fas fa-check-square status-icon ico-success'></i>";
        }
        // append container
...
var getFeaturedRepos= function(language) {
    var apiUrl = "https://pi.github.com/search/repositories?q=" + language + "+is:featured&sort=help-wanted-issues";
